...
var config = require('../config/webpack-chrome-ext.config.dev');
...
if (!checkRequiredFiles([paths.appHtml, paths.appIndexJs, paths.appSettingsHtml, paths.appSettingsJs])) {
  process.exit(1);
}
...
function copyPublicFolder() {
  fs.copySync(paths.appPublic, paths.appBuild, {
    dereference: true,
    filter: file => file !== paths.appHtml && file !== paths.appSettingsHtml
  });
}
